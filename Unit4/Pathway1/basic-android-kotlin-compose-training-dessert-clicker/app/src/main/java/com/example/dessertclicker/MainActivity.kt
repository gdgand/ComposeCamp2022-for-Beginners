...
/**
 * Determine which dessert to show. : 요 기능을 걍 updateDessertStatus()에 집어 넣어버렸음... 근데 내가 생각한대로 동작하는 건 아닌거 같다.
 */
...
//): Int {
//
//    if (dessertsSold >= dessertList[currentIdx].startProductionAmount) {
//        nextDessert()
//
//        Log.d("mainactivity", "currentIdx" + currentIdx)
//
//
//    } else {
//        Log.d("mainactivity", "currentIdx" + currentIdx)
...
//    }
    ...
    Scaffold(
        ...
        DessertClickerScreen(
            revenue = appUiState.revenue,
            dessertsSold = appUiState.dessertsSold,
            dessertImageId = dessertList[appUiState.currentDessertIndex].imageId,
            onDessertClicked = {
                appViewModel.updateDessertStatus()
            },

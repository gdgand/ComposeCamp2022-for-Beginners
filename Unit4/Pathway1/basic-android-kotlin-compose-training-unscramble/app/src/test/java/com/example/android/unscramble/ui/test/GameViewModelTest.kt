...
class GameViewModelTest {
    ...
    // -> 이게 보아하니, test소스셋에 있는 data가 대체 되어서 작동하는건가보다.
    // 2. 시작코드 개요에 적혀있다.
    ...
    fun gameViewModel_Initialization_FirstWordLoaded() {
        ...
        assertTrue(gameUiState.currentWordCount == 1) // 이거 1로 되야하는데? 코드랩에 뭔가 빠진듯? //GameUiState에서 1로 셋팅되게 바꿔야겠구나.
    ...
    fun gameViewModel_AllWordsGuessed_UiStateUpdatedCorrectly() {
        ...
        repeat(MAX_NO_OF_WORDS) {
            ...
            // ui상태에서 -> correctPlayerWord의 맞는 값을 찾아내서 저장해둠.
            currentGameUiState = viewModel.uiState.value
    ...
    fun gameViewModel_WordSkipped_ScoreUnchangedAndWordCountIncreased() {
        ...
        viewModel.skipWord() // 이거를 하면 스코어가 바뀜.

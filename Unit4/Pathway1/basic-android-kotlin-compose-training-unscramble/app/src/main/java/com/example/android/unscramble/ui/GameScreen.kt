...
import com.example.android.unscramble.viewmodel.GameScreenVM


@Composable
fun GameScreen(
    modifier: Modifier = Modifier,
    vm: GameScreenVM = viewModel()
) {
    ...
    Column(
        ...
        GameLayout(
            ...
            currentScrambledWord = uiState.curScrambledWord,

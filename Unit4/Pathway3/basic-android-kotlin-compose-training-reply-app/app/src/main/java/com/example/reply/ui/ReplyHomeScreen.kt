...
private fun ReplyAppContent(
    ...
    Row(modifier = modifier.fillMaxSize()) {
        AnimatedVisibility(visible = ReplyNavigationType.NAVIGATION_RAIL == navigationType) {
            ReplyNavigationRail(
        ...
        Column(
            ...
            AnimatedVisibility(visible = ReplyNavigationType.BOTOM_NAVIGATION == navigationType) {

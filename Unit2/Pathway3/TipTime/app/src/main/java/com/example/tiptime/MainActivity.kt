...
fun TipTimeScreen() {
    ...
    val tipString = calculateTip(amount)

    Column(modifier = Modifier.padding(32.dp).fillMaxSize().wrapContentSize()
...
@Composable
fun EditNumberField(amountInput: String, onValueChange: (String) -> Unit ) {

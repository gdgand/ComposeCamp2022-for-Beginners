        ...
        when (currentStep) {
            1 -> {
                ...
                LemonTextAndImage(
                    ...
                    contentDescriptionResourceId = R.string.first,
                    onImageClick = {
                        // Update to next step
                        currentStep = 2
            ...
            2 -> {
                ...
                LemonTextAndImage(
                    ...
                    contentDescriptionResourceId = R.string.second,
                    onImageClick = {
            ...
            3 -> {
                ...
                LemonTextAndImage(
                    ...
                    contentDescriptionResourceId = R.string.third,
                    onImageClick = {
                        // Update to next step
                        currentStep = 4
                    }
            ...
            4 -> {
                ...
                LemonTextAndImage(
                    ...
                    contentDescriptionResourceId = R.string.fourth,
                    onImageClick = {

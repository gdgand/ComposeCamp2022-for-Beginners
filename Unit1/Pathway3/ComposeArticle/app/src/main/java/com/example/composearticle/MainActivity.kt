    ...
    Column() {
        ...
        Text(text = title,
            modifier.fillMaxWidth().wrapContentWidth(Alignment.Start)
                .padding(start = 16.dp, end = 16.dp, top = 16.dp, bottom = 16.dp), fontSize = 24.sp)

        Text(text = shortDescription,modifier.wrapContentWidth(Alignment.Start)
            .padding(start = 16.dp, end = 16.dp), textAlign = TextAlign.Justify)
        Text(text = longDescription,modifier.wrapContentWidth(Alignment.Start)
            .padding(start = 16.dp, end = 16.dp, top = 16.dp, bottom = 16.dp), textAlign = TextAlign.Justify)
    }
}

...
fun ComposeQuadrantApp() {
    Column(Modifier.fillMaxWidth()) {
        ...
        Row(Modifier.weight(1f)) {
            ...
            ComposableInfoCard(title = stringResource(id = R.string.fourth_title), description = stringResource(id = R.string.fourth_description), backgroundColor =Color.LightGray ,modifier = Modifier.weight(1f))
        }
    }
}
